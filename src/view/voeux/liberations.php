  ...
  <tbody>
    <?php foreach ($data as $key => $value) : ?>
      <tr>
        ...
        <td><?= $value["r_montant"] ?></td>
        <td><?= $value["r_date"] ?></td>
        <td>
          <!-- cool -->
          <a href="/liberation/update?_=<?= $value["r_code"] ?>"><button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brush-fill" viewBox="0 0 16 16">
